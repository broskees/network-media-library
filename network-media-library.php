...
class ACF_Value_Filter {
	...
	/**
	 * Fiters the return value when using field retrieval functions in Advanced Custom Fields.		 * Transforms an Advanced Custom Field into the format specified return format.
	 *
